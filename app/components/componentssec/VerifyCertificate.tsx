        ...
        <div className="w-full">
          <div className="flex justify-between flex-wrap-reverse lg:flex-wrap-reverse-none gap-6 lg:gap-0 lg:p-10 p-5">
            ...
            <div className="w-full relative lg:w-[469px] lg:h-[455px] h-[480px] border rounded-2xl bg-white">
              ...
              <div className="w-full flex justify-start absolute lg:left-12 left-0">
                <span>
                  <Image
                    src={logobanner}
                    alt="certificate"
                    width={76}
                    height={275}
                    className="w-full ml-6 lg:ml-0 lg:w-[76px] lg:h-[275px] h-[135px]"
                  />
                </span>
                <div className="w-full absolute lg:top-[32px] top-[10px] left-4">
                  <Image
                    ...
                    width={44}
                    height={10}
                    className="w-[34px] lg:w-[44px] h-[10px] ml-[21px] lg:ml-0"
                  />
                </div>
                <div className="w-full absolute lg:top-[120px] top-[30px] lg:left-[1px] left-[18px]">
                  <Image
                    src={group}
                    alt="certificate"
                    width={74.187}
                ...
                <div className="w-full absolute lg:top-[200px] top-[80px] lg:-left-1 left-3 ">
                  <Image
                    src={botbanner}
                    alt="certificate"
                    width={76}
